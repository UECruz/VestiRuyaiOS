...
class CustomScreen07: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource {

    @IBOutlet weak var navigationBAr: UINavigationBar!
    @IBOutlet weak var collectionview07: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        navigationBAr.topItem?.title = "Select Your Embellishment Type"
        
        self.collectionview07.delegate = self
        self.collectionview07.dataSource = self
        
        // Do any additional setup after loading the view.
        
        let ref = Database.database().reference()
        ref.child("Materials").child("Embellishment").observe(DataEventType.value, with: {(snap) in
            if snap.childrenCount > 0{
             ...
             self.collectionview07.reloadData()
        })
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell07", for: indexPath) as! ItemDetail07
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if customDress.count == 7 {
            customDress.remove(at: 6)
        }
        var dict = Dictionary<String, AnyObject>()
        dict.updateValue(material.title as AnyObject, forKey: "embellishment")
    ...
    @IBAction func navigateToNextScreen(_ sender : Any) {
        if customDress.count == 6 {
            ...
            let customScreen = self.storyboard?.instantiateViewController(withIdentifier: "CustomSummary02") as! CustomSummary02
